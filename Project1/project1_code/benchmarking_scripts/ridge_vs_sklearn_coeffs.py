...
with open(script_path + '\\..\\..\\output\\benchmarks\\ridge_sklearn_compare_coeffs_pol_degree=' + str(pol_degree) + '_datapoints=' + str(data_size) + '.txt', 'w') as f:
    f.write('Coefficient, Coefficients (ridge_homemade), Coefficients (Ridge sklearn) \n')
