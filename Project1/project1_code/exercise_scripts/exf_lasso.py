...
# Plot MSE
plot_mse_per_poldegree([mses_train, mses_test, mses_bs_train, mses_bs_test], ['Lasso train', 'Lasso test', 'Bootstrap train', 'Bootstrap test'], pol_degree=pol_degree, save_plot = save_fig, save_title = 'bootstrap_lasso_n=' + str(data_size) + ', lambda=' + str(lamb) + ', iterations=' + str(num_iterations))
plt.show()
plt.clf()

plot_mse_per_poldegree([mses_train_cv, mses_test_cv, mses_bs_train, mses_bs_test], ['CV train', 'CV test', 'Bootstrap train', 'Bootstrap test'], pol_degree=pol_degree, save_plot = save_fig, save_title = 'bootstrap_crossval_lasso_n=' + str(data_size) + ', lambda=' + str(lamb) + ', iterations=' + str(num_iterations))
plt.show()
plt.clf()

plot_bias_variance(biases, variances, mses_bias_vars, pol_degree, save_plot=save_fig, save_title='bootstrap_biasVar_lasso_n=' + str(data_size) + ', lambda=' + str(lamb) + ', iterations=' + str(num_iterations))
plt.show()
