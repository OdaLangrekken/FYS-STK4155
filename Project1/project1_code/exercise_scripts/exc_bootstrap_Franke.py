...
from project1_code.model_selection import R2, MSE, bootstrap, bias_variance_decomp
...
plot_bias_variance(biases, variances, mses_bias_vars, pol_degree, save_plot=False, save_title='bootstrap_biasVar_n=' + str(data_size) + ', sigma=' + str(error_std) + ', iterations=' + str(num_iterations))
plt.show()